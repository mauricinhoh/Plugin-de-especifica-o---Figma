 ...
 */
async function identifyCoreTypeForInstance(instance: InstanceNode): Promise<CoreIdentificationResult> {
 ...
 */
function identifyCoreTypeForComponent(component: ComponentNode): CoreIdentificationResult {
