 ...
 * campo de texto — pedido do usuário: quando o Tipo de marcação é
 * "Notas do designer", o campo abaixo devia dizer "Escreva sua
 * observação" em vez de "Verbalização esperada", já que ali não é
 * uma verbalização de acessibilidade, é uma anotação livre do
 * designer. Nenhuma outra categoria muda.
 */
const DESIGNER_NOTES_MARKUP_TYPE = "notas-designer";
...
export function Card({
  ...
  const summary = !selectedOption || selectedOption.key === "nao-especificado" ? null : selectedOption.label;
